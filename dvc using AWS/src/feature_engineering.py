...
def main():
    try:
        ...
        train_data = load_data('./dvc using AWS/data/interim/train_processed.csv')
        test_data = load_data('./dvc using AWS/data/interim/test_processed.csv')

        train_df, test_df = apply_tfidf(train_data, test_data, max_features)

        save_data(train_df, os.path.join("./dvc using AWS/data", "processed", "train_tfidf.csv"))
        save_data(test_df, os.path.join("./dvc using AWS/data", "processed", "test_tfidf.csv"))
    except Exception as e:
